...
public class ConstantsEJS {
    ...
    public static final String FEIGN_VALUE_USER = "USER-PROVIDER";

    public static final String FEIGN_CLIENTS_USER = "com.linkcar.user.service";

    public static final String FEIGN_CLIENTS = "com.linkcar";

    /**
     * Rest 接口返回数据结构 json utf-8
     */
    public static final String REQUESTMAPPING_PRODUCES = "application/json;charset=UTF-8";
     ...
     * 商家类型 1、自营
     */
    public static final int SELLER_TYPE_SELF_MANAGER = 1;

    /**
     * 商家类型 2、第三方入住
     */
    public static final int SELLER_TYPE_NOT_SELF_MANAGER = 2;
    /**
     * 角色状态:未删除
     */
